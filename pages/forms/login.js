    ...
    return (
        <Container>
            <form className="bg-white rounded p-8 pt-10 pb-20">
                ...
                <input className="w-full py-2 border-2 rounded px-2" id="username" type="text" placeholder="Username" required />

                <label className="block text-md mb-2 mt-2 font-bold" htmlFor="password">Password<RStar/></label>
                <input className="w-full py-2 border-2 rounded px-2 mb-4" id="password" type="password" placeholder="Password" required />
